...
class MntConsultorio extends \Minsal\SiapsBundle\Entity\MntConsultorio implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntConsultorio' . "\0" . 'id', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntConsultorio' . "\0" . 'descripcion', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntConsultorio' . "\0" . 'area', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntConsultorio' . "\0" . 'idusuarioreg', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntConsultorio' . "\0" . 'fechahorareg');
        }
