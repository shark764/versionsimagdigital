...
/* MinsalSimagdBundle:ImgDiagnosticoAdmin:diag_show.html.twig */
class __TwigTemplate_b0de60fc62885b5f75a3f880686b91ce93fedc2c72ec800b73e0942b449c9e5e extends Twig_Template
{
...
";
    ...
    public function block_actions($context, array $blocks = array())
    {
        ...
        ";
        // line 13
        if (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"))) && ($this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_LECTURA_CREATE") || $this->env->getExtension('security')->isGranted("ROLE_ADMIN")))) {
            // line 14
            echo "            ";
            try {
                $this->env->loadTemplate("MinsalSimagdBundle:ImgEstudioPacienteAdmin:est_recuperarEstudio_button.html.twig")->display(array_merge($context, array("estudioPaciente" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "idEstudio"))));
    ...
    <li>
        ";
        // line 19
        if ((($this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "isGranted", array(0 => "EDIT", 1 => (isset($context["object"]) ? $context["object"] : $this->getContext($context, "object"))), "method") && $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "hasRoute", array(0 => "edit"), "method")) && (((($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idUserReg"), "id") == $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "id")) || ((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idUserMod"))) && ($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idUserMod"), "id") == $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "id")))) || ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "idUserReg"), "id") == $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user"), "id"))) || $this->env->getExtension('security')->isGranted("ROLE_ADMIN")))) {
            // line 22
            echo "            ";
    ...
    <li>";
        // line 27
        $this->env->loadTemplate("MinsalSimagdBundle:ImgDiagnosticoAdmin:diag_nota_button.html.twig")->display($context);
        echo "</li>
";
    }
    ...
    public function block_simagd_form_navbar_brand_title($context, array $blocks = array())
    {
        ...
        <span class=\"label label-primary-v2\">
            <i class=\"fa fa-clipboard\"></i> <i class=\"fa fa-eye\"></i> Diagnóstico radiológico para estudio de: <i>";
        // line 33
        echo twig_escape_filter($this->env, twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "idEstudio"), "idExpediente"), "idPaciente"), 50), "html", null, true);
        echo "</i>
        </span>
    </span>
";
    ...
    public function block_custom_entity_support($context, array $blocks = array())
    {
        ...
        ";
        // line 41
        if ((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura")))) {
            // line 42
            echo "            ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("MinsalSimagdBundle:ImgDiagnosticoAdmin:mostrarInformacionModal", array("idLecturaPadre" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "id"), "id" => (($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) ? ($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) : ((-1))), "_sonata_admin" => "minsal_simagd.admin.img_diagnostico")));
            // line 45
            echo "
        ";
        }
