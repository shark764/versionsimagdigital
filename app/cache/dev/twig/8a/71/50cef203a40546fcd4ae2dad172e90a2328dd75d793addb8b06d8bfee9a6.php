...
/* MinsalSimagdBundle:ImgSolicitudDiagnosticoAdmin:soldiag_edit.html.twig */
class __TwigTemplate_8a7150cef203a40546fcd4ae2dad172e90a2328dd75d793addb8b06d8bfee9a6 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 6
        $context["_soldiagMessageTemplate"] = (((array_key_exists("action", $context) && ((isset($context["action"]) ? $context["action"] : $this->getContext($context, "action")) == "edit"))) ? ((("<i class=\"fa fa-paperclip\"></i> <i class=\"fa fa-pencil-square-o\"></i> Edición de solicitud de diagnóstico para: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")) : ((("<i class=\"fa fa-paperclip\"></i> <i class=\"fa fa-plus-circle\"></i> Solicitar diagnóstico para estudio de: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")));
    ...
    <script type=\"text/javascript\" src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/minsalsimagd/js/ImgSolicitudDiagnosticoAdmin/soldiag_config_picker.js"), "html", null, true);
        echo "\" ></script>
    ...
    ";
        // line 17
        $this->env->loadTemplate("MinsalSimagdBundle:ImgSolicitudDiagnosticoAdmin:soldiag_funcionesClienteServidor.js.twig")->display($context);
        // line 18
        echo "    
    ";
        // line 19
        $this->env->loadTemplate("MinsalSimagdBundle:ImgSolicitudDiagnosticoAdmin:soldiag_bootstrapValidator.js.twig")->display($context);
        // line 20
        echo "    
    ";
        // line 21
        if (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"))) && (($this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_SOLICITUD_DIAGNOSTICO_CREATE") && $this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_ESTUDIO_PACIENTE_VIEW")) || $this->env->getExtension('security')->isGranted("ROLE_ADMIN")))) {
            // line 23
            echo "        ";
            try {
                $this->env->loadTemplate("MinsalSimagdBundle:ImgEstudioPacienteAdmin:est_recuperarEstudio.js.twig")->display(array_merge($context, array("estudioPaciente" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"))));
    ...
    public function block_simagd_form_navbar_brand_title($context, array $blocks = array())
    {
        ...
        echo "\"> ";
        echo (isset($context["_soldiagMessageTemplate"]) ? $context["_soldiagMessageTemplate"] : $this->getContext($context, "_soldiagMessageTemplate"));
        echo " </span>
    </span>
";
    }
    ...
    public function block_form($context, array $blocks = array())
    {
        // line 43
        echo "    ";
        $context["soldiag_vars"] = array("simagd_title" => "FORMULARIO PARA SOLICITAR DIAGNÓSTICO DE ESTUDIO IMAGENOLÓGICO", "simagd_message" => "Llene este formulario para solicitar diagnóstico para el estudio de Imagenología que preinscribió");
        // line 46
        echo "    ";
        try {
            $this->env->loadTemplate("MinsalSimagdBundle:Menu:simagd_cabecera.html.twig")->display(array_merge($context, (isset($context["soldiag_vars"]) ? $context["soldiag_vars"] : $this->getContext($context, "soldiag_vars"))));
        } catch (Twig_Error_Loader $e) {
            // ignore missing template
        }
...
";
    ...
    public function block_custom_entity_support($context, array $blocks = array())
    {
        ...
        ";
        // line 54
        if (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idSolicitudEstudio"))) && (!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"))))) {
            // line 55
            echo "            ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("MinsalSimagdBundle:ImgSolicitudDiagnosticoAdmin:mostrarInformacionModal", array("idSolicitudEstudioPadre" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idSolicitudEstudio"), "id"), "idEstudioPadre" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"), "id"), "id" => (($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) ? ($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) : ((-1))), "_sonata_admin" => "minsal_simagd.admin.img_solicitud_diagnostico")));
            // line 59
            echo "
        ";
        }
