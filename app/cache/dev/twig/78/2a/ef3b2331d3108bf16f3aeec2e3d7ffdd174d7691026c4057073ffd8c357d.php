...
/* MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_report_estudiosSolicitadosMedicoModalidad.html.twig */
class __TwigTemplate_782aef3b2331d3108bf16f3aeec2e3d7ffdd174d7691026c4057073ffd8c357d extends Twig_Template
{
    ...
    <form id=\"formEstudiosSolicitadosMedicoModalidad\" method=\"post\" class=\"form-horizontal\" >

        <div class=\"form-group col-sm-12\">
            <label class=\"col-sm-2 control-label\">Fecha Inicio</label>
            <div class=\"col-sm-4\">
                <input type=\"text\" class=\"form-control\" id=\"fechaIni_7\" name=\"fechaIni_7\" readonly=\"readonly\" />
            </div>
            <label class=\"col-sm-2 control-label\">Fecha final</label>
            <div class=\"col-sm-4\">
                <input type=\"text\" class=\"form-control\" id=\"fechaFin_7\" name=\"fechaFin_7\" readonly=\"readonly\" />
            </div>
        </div>
        <div class=\"form-group col-sm-12\">
            <label class=\"col-sm-2 control-label\">Modalidad</label>
            <div class=\"col-sm-6\">
                <select id=\"modalidadPreinscrita_7\" name=\"modalidadPreinscrita_7\" class=\"form-control\">
                    <option value=\"\"></option>
                    <optgroup label=\"Imagenología\">
                    ";
        // line 22
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["modalidadesPrc"]) ? $context["modalidadesPrc"] : $this->getContext($context, "modalidadesPrc")));
        foreach ($context['_seq'] as $context["_key"] => $context["modalidadPrc"]) {
            // line 23
            echo "                        <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["modalidadPrc"]) ? $context["modalidadPrc"] : $this->getContext($context, "modalidadPrc")), "id"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, (isset($context["modalidadPrc"]) ? $context["modalidadPrc"] : $this->getContext($context, "modalidadPrc")), "html", null, true);
            echo "</option>
                    ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['modalidadPrc'], $context['_parent'], $context['loop']);
        ...
        <div class=\"form-group col-sm-12\">
            ...
            <div class=\"col-sm-6\">
                <select id=\"preinscriptorEstudio_7\" name=\"preinscriptorEstudio_7\" class=\"form-control\">
                    <option value=\"\"></option>
                    ";
        // line 34
        $context['_parent'] = (array) $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tipo"]) {
            if (($this->getAttribute((isset($context["tipo"]) ? $context["tipo"] : $this->getContext($context, "tipo")), "codigo") == "MED")) {
                ...
                // line 36
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable((isset($context["preinscriptores"]) ? $context["preinscriptores"] : $this->getContext($context, "preinscriptores")));
                foreach ($context['_seq'] as $context["_key"] => $context["preinscriptor"]) {
                    if (((!(null === $this->getAttribute((isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "idTipoEmpleado"))) && ($this->getAttribute($this->getAttribute((isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "idTipoEmpleado"), "id") == $this->getAttribute((isset($context["tipo"]) ? $context["tipo"] : $this->getContext($context, "tipo")), "id")))) {
                        // line 37
                        echo "                            <option value=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "id"), "html", null, true);
                        echo "\">";
                        echo twig_escape_filter($this->env, (isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "html", null, true);
                        echo "</option>
                        ";
                    }
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['preinscriptor'], $context['_parent'], $context['loop']);
                $context = array_intersect_key($context, $_parent) + $_parent;
                // line 39
                echo "                        </optgroup>
                    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["preinscriptores"]) ? $context["preinscriptores"] : $this->getContext($context, "preinscriptores")));
        foreach ($context['_seq'] as $context["_key"] => $context["preinscriptor"]) {
            if ((null === $this->getAttribute((isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "idTipoEmpleado"))) {
                // line 42
                echo "                        <option value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["preinscriptor"]) ? $context["preinscriptor"] : $this->getContext($context, "preinscriptor")), "id"), "html", null, true);
                echo "\">";
        ...
        <input type=\"hidden\" class=\"form-control\" name=\"report_selector\" value=\"7\" />
    ...
    {
        return "MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_report_estudiosSolicitadosMedicoModalidad.html.twig";
    }
