...
/* MinsalSeguimientoBundle:SecHistorialClinicoAdmin:sec_detalleSolEst_totalInfo.html.twig */
class __TwigTemplate_db041515b2519101bc8d61e81e1067eae41e79c3accc6cb3e11bde93600bebdc extends Twig_Template
{
...
";
        // line 4
        echo "<div id=\"detalleSolEstFullData-showModalContainer\" class=\"modal container fade justify-bootstrap-div-container\" role=\"dialog\" tabindex=\"-1\" style=\"display: none;\" data-backdrop=\"static\" data-keyboard=\"false\">
    <div class=\"modal-content panel-info\">
        <div class=\"modal-header panel-heading\">
            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\"> <i class=\"fa fa-times\"></i> </button>
            <h4 class=\"modal-title\"><i class=\"fa fa-check-square-o\"></i> Detalle de la Solicitud de Estudio</h4>
        </div>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["detallesSolEst"]) ? $context["detallesSolEst"] : $this->getContext($context, "detallesSolEst")));
        foreach ($context['_seq'] as $context["_key"] => $context["detalleSolEst"]) {
            ...
            echo "\" class=\"div-det-est-sol-completa-info\">
                    ...
                    <table class=\"table table-condensed\">
                        <tr>
                            ...
                            <td class=\"col-md-4\">
                                ";
            // line 20
            echo $this->env->getExtension('sonata_intl_datetime')->formatDate($this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "fechahorareg"), "EEEE, MMMM d, yyyy", "es_ES");
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Solicitó:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "idempleado"), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Solicitado desde:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "idestablecimiento"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Solicitado hacia:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 34
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "idestablecimientoexterno"), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Modalidad/Área:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 40
            ...
            echo "
                            ...
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Examen requerido:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 44
            ...
            echo "
                        ...
                        <tr>
                            ...
                            <td class=\"col-md-4\">
                                ";
            // line 50
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "estadodetalle"), "html", null, true);
            echo "
                            </td>
                            ...
                            <td class=\"col-md-4\">
                                ";
            // line 54
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "idusuarioreg"), "html", null, true);
            echo " <strong> ( ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "idusuarioreg"), "username"), "html", null, true);
            echo " ) </strong>
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Indicación:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 60
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "indicacion"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Observación:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 64
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["detalleSolEst"]) ? $context["detalleSolEst"] : $this->getContext($context, "detalleSolEst")), "observacion"), "html", null, true);
            echo "
                            </td>
                        </tr>
                    </table>
    ...
    {
        return "MinsalSeguimientoBundle:SecHistorialClinicoAdmin:sec_detalleSolEst_totalInfo.html.twig";
    }
