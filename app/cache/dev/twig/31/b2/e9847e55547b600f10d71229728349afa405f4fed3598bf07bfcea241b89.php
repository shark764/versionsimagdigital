...
/* MinsalSimagdBundle:ImgSolicitudEstudioAdmin:prc_exploracionSol_totalInfo.html.twig */
class __TwigTemplate_31b2e9847e55547b600f10d71229728349afa405f4fed3598bf07bfcea241b89 extends Twig_Template
{
...
";
        // line 4
        echo "<div id=\"exploracionSolFullData-showModalContainer\" class=\"modal container fade justify-bootstrap-div-container\" role=\"dialog\" tabindex=\"-1\" style=\"display: none;\" data-backdrop=\"static\" data-keyboard=\"false\">
    <div class=\"modal-content panel-info\">
        <div class=\"modal-header panel-heading\">
            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\"> <i class=\"fa fa-times\"></i> </button>
            <h4 class=\"modal-title\"><i class=\"fa fa-check-square-o\"></i> Proyección Solicitada</h4>
        </div>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["explSolicitadas"]) ? $context["explSolicitadas"] : $this->getContext($context, "explSolicitadas")));
        foreach ($context['_seq'] as $context["_key"] => $context["explSol"]) {
            // line 14
            echo "                <div data-id=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "id"), "html", null, true);
            echo "\" class=\"div-expl-sol-completa-info\">
                    ...
                    <table class=\"table table-condensed\">
                        <tr>
                            ...
                            <td class=\"col-md-4\">
                                ";
            // line 20
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Agrupada en el examen:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "idExamenServicioDiagnostico"), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Código:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "codigo"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Aplica al sexo:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 34
            echo twig_escape_filter($this->env, (((!(null === $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "idExamenServicioDiagnostico"), "idsexo")))) ? ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "idExamenServicioDiagnostico"), "idsexo")) : ("Todos los sexos")), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Tiempo en sala (min):</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 40
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "tiempoOcupacionSala"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Tiempo de Tecnólogo (min):</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 44
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "idProyeccionSolicitada"), "tiempoMedico"), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Vistas solicitadas:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 50
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "vistasRequeridas"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Posición solicitada:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 54
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "posicionExaminar"), "html", null, true);
            echo "
                            </td>
                        </tr>
                        <tr>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Dimensiones:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 60
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "dimensiones"), "html", null, true);
            echo "
                            </td>
                            <th class=\"col-md-2\"><span class=\"simagd-text-primary\">Otras especificaciones:</span></th>
                            <td class=\"col-md-4\">
                                ";
            // line 64
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["explSol"]) ? $context["explSol"] : $this->getContext($context, "explSol")), "otrasEspecificaciones"), "html", null, true);
            echo "
                            </td>
                        </tr>
                    </table>
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['explSol'], $context['_parent'], $context['loop']);
    ...
    {
        return "MinsalSimagdBundle:ImgSolicitudEstudioAdmin:prc_exploracionSol_totalInfo.html.twig";
    }
