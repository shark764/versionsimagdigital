...
/* MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_reportes_estudiosDiagnosticadosRadiologoModalidad_bootstrapValidator.js.twig */
class __TwigTemplate_3011de2ad9c6702e3d8072a84e07406563fca7618e0fd1042bbdd435ac92761e extends Twig_Template
{
...
";
    ...
    <script type=\"text/javascript\">
        jQuery(document).ready(function() {
            ...
            \$(\"form[id='formEstudiosDiagnosticadosRadiologoModalidad']\").bootstrapValidator({
                //excluded: [':disabled'],
                feedbackIcons: {
                        ...
                        validators: {
                            callback: {
                                ...
                                callback: function(value, validator) {
                                    ...
                                    var dateIniAsObject = \$(\"#fechaIni_8\").datepicker( 'getDate' );
                                    var dateFinAsObject = \$(\"#fechaFin_8\").datepicker( 'getDate' );
...
\t\t\t\t    
                    ...
                    radiologoDiagnostico_8: {
                        message: 'Radiólogo es inválido',
                        validators: {
                            notEmpty: {
                                message: 'Radiólogo intérprete es requerido'
                            },
                        }
                    },
                }
