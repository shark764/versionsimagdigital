...
/* MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_reportes_pacientesAtendidosMedico_bootstrapValidator.js.twig */
class __TwigTemplate_4ef7acee42d4331dc2a6d753e00817a3b8694e9048a61a7ec3aa647f32fd9805 extends Twig_Template
{
...
";
    ...
    <script type=\"text/javascript\">
        jQuery(document).ready(function() {
            ...
            \$(\"form[id='formPacientesAtendidosMedico']\").bootstrapValidator({
                //excluded: [':disabled'],
                feedbackIcons: {
                        ...
                        validators: {
                            callback: {
                                ...
                                callback: function(value, validator) {
                                    ...
                                    var dateIniAsObject = \$(\"#fechaIni_2\").datepicker( 'getDate' );
                                    var dateFinAsObject = \$(\"#fechaFin_2\").datepicker( 'getDate' );
...
\t\tconsole.log(\$formParam_object );
    ...
    {
        return "MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_reportes_pacientesAtendidosMedico_bootstrapValidator.js.twig";
    }
