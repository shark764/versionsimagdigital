...
/* MinsalSimagdBundle:ImgDiagnosticoAdmin:diag_edit.html.twig */
class __TwigTemplate_f945f1efc1e2a299c6675536e320ba6d6fb0d88b7071dc867a8a70ebd73bcf57 extends Twig_Template
{
    ...
    {
        // line 5
        $context["_pacienteTitle"] = (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura")))) ? (twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "idEstudio"), "idExpediente"), "idPaciente"), 50)) : ("No hay lectura"));
        // line 6
        $context["_diagMessageTemplate"] = (((array_key_exists("action", $context) && ((isset($context["action"]) ? $context["action"] : $this->getContext($context, "action")) == "edit"))) ? ((("<i class=\"fa fa-clipboard\"></i> <i class=\"fa fa-pencil-square-o\"></i> Edición de Diagnóstico para estudio de: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")) : ((("<i class=\"fa fa-clipboard\"></i> <i class=\"fa fa-plus-circle\"></i> Transcripción de lectura para estudio de: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")));
    ...
    ";
        // line 17
        $this->env->loadTemplate("MinsalSimagdBundle:ImgDiagnosticoAdmin:diag_funcionesClienteServidor.js.twig")->display($context);
        // line 18
        echo "    
    ";
        // line 19
        $this->env->loadTemplate("MinsalSimagdBundle:ImgDiagnosticoAdmin:diag_bootstrapValidator.js.twig")->display($context);
        // line 20
        echo "    
    ";
        // line 21
        if (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"))) && ($this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_LECTURA_CREATE") || $this->env->getExtension('security')->isGranted("ROLE_ADMIN")))) {
            ...
            echo "        ";
            try {
                $this->env->loadTemplate("MinsalSimagdBundle:ImgEstudioPacienteAdmin:est_recuperarEstudio.js.twig")->display(array_merge($context, array("estudioPaciente" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idLectura"), "idEstudio"))));
    ...
    public function block_simagd_form_navbar_brand_title($context, array $blocks = array())
    {
        ...
        echo "\"> ";
        echo (isset($context["_diagMessageTemplate"]) ? $context["_diagMessageTemplate"] : $this->getContext($context, "_diagMessageTemplate"));
        echo " </span>
    </span>
";
    }
    ...
    public function block_form($context, array $blocks = array())
    {
        // line 42
        echo "    ";
        $context["diag_vars"] = array("simagd_title" => "FORMULARIO PARA TRANSCRIPCIÓN DE INTERPRETACIÓN RADIOLÓGICA", "simagd_message" => "Llene este formulario para registrar la interpretación dada por Médico radiólogo");
        // line 45
        echo "    ";
        try {
            $this->env->loadTemplate("MinsalSimagdBundle:Menu:simagd_cabecera.html.twig")->display(array_merge($context, (isset($context["diag_vars"]) ? $context["diag_vars"] : $this->getContext($context, "diag_vars"))));
        } catch (Twig_Error_Loader $e) {
            // ignore missing template
        }
