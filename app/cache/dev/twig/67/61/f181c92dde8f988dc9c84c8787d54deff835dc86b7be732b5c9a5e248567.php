...
/* MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_reportes_examenesRealizadosPaciente_bootstrapValidator.js.twig */
class __TwigTemplate_6761f181c92dde8f988dc9c84c8787d54deff835dc86b7be732b5c9a5e248567 extends Twig_Template
{
...
";
    ...
    <script type=\"text/javascript\">
        jQuery(document).ready(function() {
            ...
            \$(\"form[id='formExamenesRealizadosPaciente']\").bootstrapValidator({
                //excluded: [':disabled'],
                feedbackIcons: {
                        ...
                        validators: {
                            callback: {
                                ...
                                callback: function(value, validator) {
                                    ...
                                    var dateIniAsObject = \$(\"#fechaIni_5\").datepicker( 'getDate' );
                                    var dateFinAsObject = \$(\"#fechaFin_5\").datepicker( 'getDate' );
...
\t\t\t\t    
                    ...
                    pacienteAtendido_5: {
                        message: 'Paciente es inválido',
                        validators: {
                            notEmpty: {
                                message: 'Paciente atendido es requerido'
                            },
                        }
                    },
                }
