...
/* MinsalSimagdBundle:GeneracionReporteImagenologiaAdmin:simagd_reportes_estudiosSolicitadosMedicoModalidad_bootstrapValidator.js.twig */
class __TwigTemplate_05f9001e6bd9af9f8d849e720e8ef29737d213628b73824c8fbe7e705b3a5c60 extends Twig_Template
{
...
";
    ...
    <script type=\"text/javascript\">
        jQuery(document).ready(function() {
            ...
            \$(\"form[id='formEstudiosSolicitadosMedicoModalidad']\").bootstrapValidator({
                //excluded: [':disabled'],
                feedbackIcons: {
                        ...
                        validators: {
                            callback: {
                                ...
                                callback: function(value, validator) {
                                    ...
                                    var dateIniAsObject = \$(\"#fechaIni_7\").datepicker( 'getDate' );
                                    var dateFinAsObject = \$(\"#fechaFin_7\").datepicker( 'getDate' );
...
\t\t\t\t    
                    ...
                    preinscriptorEstudio_7: {
                        message: 'Preinscriptor es inválido',
                        validators: {
                            notEmpty: {
                                message: 'Solicitante de estudios es requerido'
                            },
                        }
                    },
                }
