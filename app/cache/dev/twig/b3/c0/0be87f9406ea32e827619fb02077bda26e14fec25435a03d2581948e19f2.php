...
/* MinsalSimagdBundle:ImgNotaDiagnosticoAdmin:notdiag_edit.html.twig */
class __TwigTemplate_b3c00be87f9406ea32e827619fb02077bda26e14fec25435a03d2581948e19f2 extends Twig_Template
{
    ...
    {
        // line 5
        $context["_pacienteTitle"] = (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico")))) ? (twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico"), "idLectura"), "idEstudio"), "idExpediente"), "idPaciente"), 50)) : ("No hay diagnóstico"));
        // line 6
        $context["_notdiagMessageTemplate"] = (((array_key_exists("action", $context) && ((isset($context["action"]) ? $context["action"] : $this->getContext($context, "action")) == "edit"))) ? ((("<i class=\"fa fa-comment\"></i> <i class=\"fa fa-pencil-square-o\"></i> Edición de nota agregada al diagnóstico para: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")) : ((("<i class=\"fa fa-comment\"></i> <i class=\"fa fa-plus-circle\"></i> Agregar nota a diagnóstico de estudio de: <i>" . (isset($context["_pacienteTitle"]) ? $context["_pacienteTitle"] : $this->getContext($context, "_pacienteTitle"))) . "</i>")));
    ...
    <script type=\"text/javascript\" src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/minsalsimagd/js/ImgNotaDiagnosticoAdmin/notdiag_config_notaDiag_modal.js"), "html", null, true);
        echo "\" ></script>
    
    ";
        // line 15
        $this->env->loadTemplate("MinsalSimagdBundle:ImgNotaDiagnosticoAdmin:notdiag_bootstrapValidator.js.twig")->display($context);
        // line 16
        echo "    
    ";
        // line 17
        $this->env->loadTemplate("MinsalSimagdBundle:ImgNotaDiagnosticoAdmin:notdiag_funcionesClienteServidor.js.twig")->display($context);
        // line 18
        echo "    
    ";
        // line 19
        if (((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico"))) && (($this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_NOTA_DIAGNOSTICO_CREATE") && $this->env->getExtension('security')->isGranted("ROLE_MINSAL_SIMAGD_ADMIN_IMG_ESTUDIO_PACIENTE_VIEW")) || $this->env->getExtension('security')->isGranted("ROLE_ADMIN")))) {
            // line 21
            echo "        ";
            try {
                $this->env->loadTemplate("MinsalSimagdBundle:ImgEstudioPacienteAdmin:est_recuperarEstudio.js.twig")->display(array_merge($context, array("estudioPaciente" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico"), "idLectura"), "idEstudio"))));
    ...
    public function block_simagd_form_navbar_brand_title($context, array $blocks = array())
    {
        ...
        echo "\"> ";
        echo (isset($context["_notdiagMessageTemplate"]) ? $context["_notdiagMessageTemplate"] : $this->getContext($context, "_notdiagMessageTemplate"));
        echo " </span>
    </span>
";
    }
    ...
    public function block_form($context, array $blocks = array())
    {
        // line 41
        echo "    ";
        $context["notdiag_vars"] = array("simagd_title" => "FORMULARIO PARA AGREGAR NOTA A DIAGNÓSTICO RADIOLÓGICO", "simagd_message" => "Llene este formulario para registrar una nota u observación a un diagnóstico");
        // line 44
        echo "    ";
        try {
            $this->env->loadTemplate("MinsalSimagdBundle:Menu:simagd_cabecera.html.twig")->display(array_merge($context, (isset($context["notdiag_vars"]) ? $context["notdiag_vars"] : $this->getContext($context, "notdiag_vars"))));
        } catch (Twig_Error_Loader $e) {
            // ignore missing template
        }
    ...
    public function block_custom_entity_support($context, array $blocks = array())
    {
        ...
        if ((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico")))) {
            // line 57
            echo "            ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("MinsalSimagdBundle:ImgNotaDiagnosticoAdmin:mostrarInformacionModal", array("idDiagnosticoPadre" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idDiagnostico"), "id"), "id" => (($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) ? ($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) : ((-1))), "_sonata_admin" => "minsal_simagd.admin.img_nota_diagnostico")));
            // line 60
            echo "
        ";
        }
