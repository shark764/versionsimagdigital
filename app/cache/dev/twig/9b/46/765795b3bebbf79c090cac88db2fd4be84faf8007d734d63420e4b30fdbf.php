...
/* MinsalSimagdBundle:ImgPendienteValidacionAdmin:pndV_valid_diag_alert.html.twig */
class __TwigTemplate_9b46765795b3bebbf79c090cac88db2fd4be84faf8007d734d63420e4b30fdbf extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'simagd_valid_alert' => array($this, 'block_simagd_valid_alert'),
        );
    }
...
";
        // line 3
        $this->displayBlock('simagd_valid_alert', $context, $blocks);
    }

    public function block_simagd_valid_alert($context, array $blocks = array())
    {
        // line 4
        echo "    <div class=\"simagd-response-bs-alert\" aria-hidden=\"true\">
\t<div class=\"alert alert-info alert-dismissable\" id=\"simagd-valid-response-bs-alert\" style=\"display: none;\">
\t    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">x</button>
\t    <span>
\t\t<span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"></span>
\t\t<strong>Aprobado! &nbsp; </strong> El diagnóstico ha sido validado exitósamente.
\t    </span>
\t</div>
    </div>
";
