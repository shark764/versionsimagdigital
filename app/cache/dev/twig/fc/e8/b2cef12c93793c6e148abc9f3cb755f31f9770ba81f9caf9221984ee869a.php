...
/* MinsalSimagdBundle:ImgLecturaAdmin:lct_show.html.twig */
class __TwigTemplate_fce8b2cef12c93793c6e148abc9f3cb755f31f9770ba81f9caf9221984ee869a extends Twig_Template
{
...
";
    ...
    public function block_simagd_form_navbar_brand_title($context, array $blocks = array())
    {
        ...
        <span class=\"label label-primary-v2\">
            <i class=\"fa fa-microphone\"></i> <i class=\"fa fa-eye\"></i> Interpretación de estudio de: <i>";
        // line 25
        echo twig_escape_filter($this->env, twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"), "idExpediente"), "idPaciente"), 50), "html", null, true);
        echo "</i>
        </span>
    </span>
";
    ...
    public function block_custom_entity_support($context, array $blocks = array())
    {
        ...
        if ((!(null === $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio")))) {
            // line 34
            echo "            ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("MinsalSimagdBundle:ImgLecturaAdmin:mostrarInformacionModal", array("idEstudioPadre" => $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "idEstudio"), "id"), "id" => (($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) ? ($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id")) : ((-1))), "_sonata_admin" => "minsal_simagd.admin.img_lectura")));
            // line 37
            echo "
        ";
        }
