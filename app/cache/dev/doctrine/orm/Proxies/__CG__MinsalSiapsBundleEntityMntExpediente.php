...
class MntExpediente extends \Minsal\SiapsBundle\Entity\MntExpediente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'id', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'numero', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'habilitado', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'idCreacionExpediente', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'idEstablecimiento', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'idPaciente', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'fechaCreacion', '' . "\0" . 'Minsal\\SiapsBundle\\Entity\\MntExpediente' . "\0" . 'horaCreacion');
        }
