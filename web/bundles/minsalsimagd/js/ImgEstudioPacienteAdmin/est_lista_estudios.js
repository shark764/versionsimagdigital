...
//    href="' + row.solcmpl_createUrl + '"
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-estudio-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar información de  detallada"' + $BTN_ALLOW_SHOWSTUDY + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<button type="button" class="btn btn-primary-v2 btn-xs dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Visualizar estudio"' + $BTN_ALLOW_DOWNLOADSTUDY + '>',
	    ...
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="complementario-estudio-action btn btn-element-v2 btn-xs " href="javascript:void(0)" target="_blank" title="Solicitar estudio complementario"' + $BTN_ALLOW_CMPLREQUEST + '>',
		    '<i class="glyphicon glyphicon-random"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<button type="button" class="btn btn-primary-v2 btn-xs dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Anexar en listado de lecturas pendientes"' + $BTN_ALLOW_ADDWORKLIST + '>',
	    ...
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="anexar-lista-lectura-estudio-v2-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Anexar en listado de lecturas pendientes"' + $BTN_ALLOW_ADDWORKLIST + '>',
		    '<i class="glyphicon glyphicon-share-alt"></i>',
		'</a>',
	    '</div>',
	'</div>'
