...
function lectura_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
	    ...
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-lectura-action btn btn-primary-v2 btn-xs " href="' + row.lct_editUrl + '" target="_blank" title="Editar registro de lectura"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-repeat"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="transcribir-lectura-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Transcribir lectura radiológica"' + (row.allowTranscribir === false ? ' disabled="disabled"' : '') + '>',
