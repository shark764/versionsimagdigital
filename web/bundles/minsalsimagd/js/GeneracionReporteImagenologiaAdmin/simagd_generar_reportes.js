...
jQuery(document).ready(function() {
    ...
    $("input[id^='fechaIni'], input[id^='fechaFin']").each(function() {
        ...
        jQuery(this).before(" <span class='input-group-btn'> <button class='reportDatepickerShow demo btn btn-primary btn-large'> <i class='glyphicon glyphicon-calendar'></i> </button> </span>");
