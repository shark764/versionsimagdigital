...
function pendienteRealizar_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="realizar-pendiente-realizar-action btn btn-primary-v2 btn-xs" href="' + row.prz_createUrl + '" target="_blank" title="Realizar examen"' + (row.allowRealizar === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-edit"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="registrar-pendiente-realizar-action btn btn-element-v2 btn-xs " href="javascript:void(0)" title="Registrar procedimiento iniciado"' + (row.allowRegInicial === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-check"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="almacenar-pendiente-realizar-action btn btn-element-v2 btn-xs " href="javascript:void(0)" title="Registrar estudio almacenado en PACS"' + (row.allowRegistrarAlmacenado === false ? ' disabled="disabled"' : '') + '>',
