...
function actionSolDiagFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
	    ...
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-solicitud-diagnostico-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar registro de solicitud de diagnóstico"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
