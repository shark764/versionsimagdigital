...
function actionSolEstudioFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-solicitud-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar solicitud detallada"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-solicitud-action btn btn-primary-v2 btn-xs " href="' + row.prc_editUrl + '" target="_blank" title="Editar solicitud de estudio"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-repeat"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="sin-cita-solicitud-action btn btn-default btn-xs " href="javascript:void(0)" title="Enviar a lista de trabajo"' + (row.allowSinCita === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-tag"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="radx-ind-solicitud-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Agregar indicaciones del Médico radiólogo"' + (row.allowIndRadx === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-log-in"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="sol-diag-solicitud-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Solicitar diagnóstico"' + (row.allowSolDiag === false ? ' disabled="disabled"' : '') + '>',
