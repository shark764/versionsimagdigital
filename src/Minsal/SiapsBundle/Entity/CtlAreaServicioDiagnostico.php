 ...
 * @ORM\Entity(repositoryClass="Minsal\SiapsBundle\Repositorio\AreaServicioDiagnosticoRepository")
 */
class CtlAreaServicioDiagnostico
{
    ...
    public function __toString() {
        return $this->nombrearea ? strtoupper($this->imgCodigo) . ' - ' . mb_strtoupper($this->nombrearea, 'utf-8') : '';
    }
