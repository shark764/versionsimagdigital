...
function pendienteLectura_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="leer-pendiente-lectura-action btn btn-primary-v2 btn-xs" href="' + row.lct_createUrl + '" target="_blank" title="Interpretar estudio"' + (row.allowInterpretar === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-eye-open"></i> Leer',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="agregar-pendiente-lectura-action btn btn-default btn-xs " href="javascript:void(0)" title="Agregar en lista personal"' + (row.allowRegInicial === false ? ' disabled="disabled"' : '') + '>',
