...
//    href="' + row.solcmpl_editUrl + '"
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a   class="show-solicitud-estudio-compl-action btn btn-primary-v4 btn-outline btn-xs" href="javascript:void(0)" title="Mostrar solicitud de estudio complementario detallado"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a   class="edit-solicitud-estudio-compl-action btn btn-primary-v4 btn-outline btn-xs " href="javascript:void(0)" target="_blank" title="Editar registro de solicitud de estudio complementario"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
...
window.actionSolEstudioCmplEvents = {
    ...
    'click .edit-solicitud-estudio-compl-action': function (e, value, row, index) {
        ...
        jQuery('#formSolcmplFastRequestLabel').removeClass('label-primary-v4')
