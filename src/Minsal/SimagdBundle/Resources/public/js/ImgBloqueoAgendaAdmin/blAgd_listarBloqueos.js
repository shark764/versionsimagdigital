...
function actionBloqueoFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-bloqueo-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar bloqueo detallado"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-bloqueo-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar bloqueo de agenda"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-repeat"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="exclude-radx-bloqueo-action btn btn-element-v2 btn-xs " href="javascript:void(0)" title="Excluir Radiólogos de bloqueo de agenda"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-user"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="remove-bloqueo-action btn btn-danger btn-xs " href="javascript:void(0)" title="Remover bloqueo de agenda"' + (row.allowRemove === false ? ' disabled="disabled"' : '') + '>',
