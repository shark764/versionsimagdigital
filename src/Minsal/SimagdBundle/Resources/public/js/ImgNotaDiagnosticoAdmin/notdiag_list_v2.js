...
function notadiagnostico_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-nota-diagnostico-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar nota al diagnóstico detallada"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-nota-diagnostico-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar registro de nota al diagnóstico"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
