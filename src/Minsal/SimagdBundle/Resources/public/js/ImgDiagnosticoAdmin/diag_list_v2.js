...
function diagnostico_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-diagnostico-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar diagnóstico detallado"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-diagnostico-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar registro de diagnóstico"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-repeat"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="nota-diagnostico-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Emitir nota al diagnóstico"' + (row.allowNota === false ? ' disabled="disabled"' : '') + '>',
