jQuery(document).ready(function() {
    ...
    $("input[id^='fecha_']").each(function() {
        ...
        jQuery(this).before(" <span class='input-group-btn'> <button class='bsqEstDatepickerShow demo btn btn-primary-v4 btn-outline btn-large'> <i class='glyphicon glyphicon-calendar'></i> </button> </span>");
    ...
    $("input[id='nec']")
            .before(" <span class='input-group-btn'> <button class='demo btn btn-primary-v4 btn-outline btn-large' id='_simagdBtnAddonNec'> <i class='glyphicon glyphicon-barcode'></i> </button> </span>");
    $("input[id='dui']")
            .before(" <span class='input-group-btn'> <button class='demo btn btn-primary-v4 btn-outline btn-large' id='_simagdBtnAddonDui'> <i class='glyphicon glyphicon-barcode'></i> </button> </span>");
