...
function pendienteTranscripcion_actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="transcribir-pendiente-transcribir-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Transcribir lectura radiológica"' + (row.allowTranscribir === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-edit"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="agregar-pendiente-transcribir-action btn btn-success-v2 btn-xs " href="javascript:void(0)" title="Agregar en lista personal"' + (row.allowRegInicial === false ? ' disabled="disabled"' : '') + '>',
