...
function actionFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-indicaciones-cita-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar indicaciones para citar pacientes detalladas"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-indicaciones-cita-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar registro de indicaciones para citar pacientes"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
