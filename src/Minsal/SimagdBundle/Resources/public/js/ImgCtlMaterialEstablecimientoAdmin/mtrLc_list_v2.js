...
function actionLocalFormatter(value, row, index) {
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-material-local-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar material detallado"' + (row.allowShow === false ? ' disabled="disabled"' : '') + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-material-local-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Editar registro de material"' + (row.allowEdit === false ? ' disabled="disabled"' : '') + '>',
