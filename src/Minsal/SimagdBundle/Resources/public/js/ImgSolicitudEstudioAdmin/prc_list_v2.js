...
//    href="' + row.prc_editUrl + '"
	...
	'<div class="btn-toolbar" role="toolbar" aria-label="...">',
		...
		'<a class="show-solicitud-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Mostrar solicitud detallada"' + $BTN_ALLOW_SHOWPRC + '>',
		    '<i class="glyphicon glyphicon-info-sign"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="edit-solicitud-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" target="_blank" title="Editar solicitud de estudio"' + $BTN_ALLOW_EDITPRC + '>',
		    '<i class="glyphicon glyphicon-repeat"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="sin-cita-solicitud-action btn btn-default btn-xs " href="javascript:void(0)" title="Enviar a lista de trabajo"' + $BTN_ALLOW_SKIPDATE + '>',
		    '<i class="glyphicon glyphicon-tag"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="radx-ind-solicitud-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Agregar indicaciones del Médico radiólogo"' + $BTN_ALLOW_ADDINDRX + '>',
		    '<i class="glyphicon glyphicon-log-in"></i>',
		'</a>',
	    '</div>',
	    '<div class="btn-group" role="group">',
		'<a class="sol-diag-solicitud-action btn btn-primary-v2 btn-xs " href="javascript:void(0)" title="Solicitar diagnóstico"' + $BTN_ALLOW_DIAGREQUEST + '>',
    ...
    return [
        '<div class="expand-box tt-item-btn-group" style="" data-exp-id="' + item.exp_id + '" data-exp-numero="' + item.exp_numero + '" data-pct-id="' + item.pct_id + '" data-pct-nombre="' + item.pct_nombreCompleto + '">',
            ...
            '<div class="btn-toolbar" role="toolbar" aria-label="..." style="float: right; margin-top: 1.2px;">',
                '<div class="btn-group" role="group">',
                    '<a class="tt-new-request-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Solicitar estudio (Formato rápido)"' + ($isGranted_studyRequest === false ? ' disabled="disabled"' : '') + '>',
                        '<i class="glyphicon glyphicon-send"></i>',
                    '</a>',
                '</div>',
                '<div class="btn-group" role="group">',
                    '<a class="tt-new-full-request-action btn btn-primary-v2 btn-xs" href="javascript:void(0)" title="Solicitar estudio (Formato detallado)"' + ($isGranted_studyRequest === false ? ' disabled="disabled"' : '') + '>',
                        '<i class="glyphicon glyphicon-edit"></i>',
                    '</a>',
                '</div>',
                '<div class="btn-group" role="group">',
                    '<a class="tt-view-patient-studies-action btn btn-element-v2 btn-xs" href="javascript:void(0)" title="Consulta de estudios de paciente"' + ($isGranted_studyView === false ? ' disabled="disabled"' : '') + '>',
