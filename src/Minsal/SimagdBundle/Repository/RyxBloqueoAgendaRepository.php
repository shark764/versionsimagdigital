...
/**
 * RyxBloqueoAgendaRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class RyxBloqueoAgendaRepository extends EntityRepository
{
    ...
    public function data($id_estab, $bs_filters = array())
    {
        $query = $this->getEntityManager()
                        ->createQueryBuilder('blAgd')
                            ...
                            ->addSelect('blAgd.id AS id, CONCAT(COALESCE(empblAgd.apellido, \'\'), \', \', COALESCE(empblAgd.nombre, \'\')) AS empleado_registra, blAgd.color AS color, blAgd.titulo AS titulo, blAgd.fechaInicio as fecha_inicio, blAgd.fechaFin as fecha_fin, blAgd.horaInicio as hora_inicio, blAgd.horaFin as hora_fin, blAgd.fechaCreacion as fecha_registro, blAgd.fechaUltimaEdicion as fecha_edicion')
