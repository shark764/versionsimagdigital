...
class RyxDiagnosticoSegundaOpinionMedicaAdminController extends MinsalSimagdBundleGeneralAdminController
{
    /**
     * TABLE GENERATOR
     *
    ...
    public function mostrarInformacionModalAction($idDiagnosticoPadre, $id)
    {
        ...
        return $this->render('MinsalSimagdBundle:RyxDiagnosticoSegundaOpinionMedicaAdmin:notdiag_modal_support.html.twig', array(
