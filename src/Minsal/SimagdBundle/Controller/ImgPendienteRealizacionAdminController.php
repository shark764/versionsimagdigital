        ...
        foreach ($results as $key => $r)
        {
            ...
            $results[$key]['action'] = '<div class="btn-toolbar" role="toolbar" aria-label="...">' .
                    '<div class="btn-group" role="group">' .
                        ...
                        '</a>' .
                        '<ul id="unrealizedproceduresworklist-context-menu" class="dropdown-menu highlight-success-dropdown-menu">' .
                    ...
                    '</div>' .
                '</div>';
            $results[$key]['action'] = '<div class="btn-toolbar" role="toolbar" aria-label="..."><div class="btn-group" role="group"><a class=" unrealizedproceduresworklist-button material-btn-list-op btn-link btn-link-black-thrash dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style=" cursor: context-menu; " role="button" href="javascript:void(0)" title="Operaciones..." ><span class="glyphicon glyphicon-cog"></span><span class="caret"></span> <span class="sr-only">Operaciones</span></a><ul class="dropdown-menu highlight-success-dropdown-menu" style="right: 0; left: auto;" role="menu"><li class="dropdown-header">MENÚ</li><li data-item="unrealizedproceduresworklist_show"><a><span class="glyphicon glyphicon-folder-open"></span>Consultar</a></li><li data-item="unrealizedproceduresworklist_edit"><a><span class="glyphicon glyphicon-edit"></span>Editar</a></li><li class="divider"></li><li data-item="unrealizedproceduresworklist_delete"><a><span class="glyphicon glyphicon-trash"></span>Borrar</a></li><li class="divider"></li><li class="dropdown-header">LISTA DE TRABAJO</li><li data-item="unrealizedproceduresworklist_save"><a><span class="glyphicon glyphicon-floppy-saved"></span>Guardar</a></li><li data-item="unrealizedproceduresworklist_saveandsearchinpacs"><a><span class="glyphicon glyphicon-link"></span>Guardar y enlazar a PACS</a></li><li data-item="unrealizedproceduresworklist_goto"><a><span class="glyphicon glyphicon-edit"></span>Acceder</a></li><li class="divider"></li><li data-item="unrealizedproceduresworklist_create"><a><span class="glyphicon glyphicon-plus-sign"></span>Crear nuevo</a></li></ul></div></div>';
