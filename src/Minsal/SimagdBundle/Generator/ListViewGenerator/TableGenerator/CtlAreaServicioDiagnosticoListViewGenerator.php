...
// use Minsal\SimagdBundle\Entity\CtlAreaServicioDiagnostico;
...
/**
 * CtlAreaServicioDiagnosticoListViewGenerator
 *
 * @author farid
 */
class CtlAreaServicioDiagnosticoListViewGenerator extends RyxEntityListViewGenerator
{
    /**
     * Sets the array.
     *
        ...
        if ($this->type === 'detail')
        {
            ...
            array_push($this->columns,
                    ...
                    array(
                        ...
                        'title' => '<span class="glyphicon glyphicon-cog"></span> OP.',
                        // 'formatter' => 'operateFormatter',
                        'events' => '__DIAGNOSTICSERVICEMODALITIES_MENU_ACTIONEVENTS__',
                    )
            );
        }
    }
    ...
    {
        ////////
        $this->entityOptions['url']         = $this->routeGenerator->generate('simagd_area_servicio_diagnostico_generateData', array('type' => $this->type));
