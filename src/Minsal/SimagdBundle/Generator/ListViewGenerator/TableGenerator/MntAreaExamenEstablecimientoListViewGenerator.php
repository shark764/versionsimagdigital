...
/**
 * MntAreaExamenEstablecimientoListViewGenerator
 *
 * @author farid
 */
class MntAreaExamenEstablecimientoListViewGenerator extends RyxEntityListViewGenerator
{
    /**
     * Sets the array.
     *
        ...
        if ($this->type === 'detail')
        {
            ...
            array_push($this->columns,
                    ...
                    array(
                        ...
                        'title' => '<span class="glyphicon glyphicon-cog"></span> OP.',
                        // 'formatter' => 'operateFormatter',
                        'events' => '__LOCALDIAGNOSTICSERVICEEXAMSBYMODALITY_MENU_ACTIONEVENTS__',
                    )
            );
        }
    }
    ...
    {
        ////////
        $this->entityOptions['url']         = $this->routeGenerator->generate('simagd_area_examen_establecimiento_generateData', array('type' => $this->type));
