...
// use Minsal\SimagdBundle\Entity\CtlExamenServicioDiagnostico;
...
/**
 * CtlExamenServicioDiagnosticoListViewGenerator
 *
 * @author farid
 */
class CtlExamenServicioDiagnosticoListViewGenerator extends RyxEntityListViewGenerator
{
    /**
     * Sets the array.
     *
        ...
        elseif ($this->type === 'detail')
        {
            ...
            array_push($this->columns,
                    ...
                    array(
                        ...
                        'title' => '<span class="glyphicon glyphicon-cog"></span> OP.',
                        // 'formatter' => 'operateFormatter',
                        'events' => '__DIAGNOSTICSERVICEEXAMS_MENU_ACTIONEVENTS__',
                    )
            );
        }
    }
    ...
    {
        ////////
        $this->entityOptions['url']         = $this->routeGenerator->generate('simagd_examen_servicio_diagnostico_generateData', array('type' => $this->type));
