...
// use Minsal\SimagdBundle\Entity\RyxBloqueoAgenda;
...
/**
 * RyxBloqueoAgendaListViewGenerator
 *
 * @author farid
 */
class RyxBloqueoAgendaListViewGenerator extends RyxEntityListViewGenerator
{
    /**
     * Sets the array.
     *
        ...
        if ($this->type === 'detail')
        {
            ...
            array_push($this->columns,
                    ...
                    array(
                        ...
                        'title' => '<span class="glyphicon glyphicon-cog"></span> OP.',
                        // 'formatter' => 'operateFormatter',
                        'events' => '__BLOCKEDDAYSANDFESTIVITIES_MENU_ACTIONEVENTS__',
                    )
            );
        }
    }
    ...
    {
        ////////
        $this->entityOptions['url']         = $this->routeGenerator->generate('simagd_bloqueo_agenda_generateData', array('type' => $this->type));
