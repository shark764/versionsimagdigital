...
class RyxSolicitudEstudioProyeccionAdmin extends MinsalSimagdBundleGeneralAdmin
{
    ...
    {
        $yeah                       = $this->getRequest()->get('__yeah', null);
        $std_proyeccion_association = $this->getRequest()->get('__std_proyeccion_association', null);
        $m_proyeccion_association   = $this->getRequest()->get('__m_proyeccion_association', null);
        ...
        $formMapper
            ...
            ->with('Detalles')
                ...
                ->add('dimensiones', null, array(
                                                    'label' => 'Dimensiones',
                                                    'required' => false,
//                                                    'data' => $std_proyeccion_association,
