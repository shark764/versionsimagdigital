...
class RyxLecturaPendienteTranscripcionAdmin extends MinsalSimagdBundleGeneralAdmin
{
...
//                            ->where('diag.idEstadoDiagnostico NOT IN ( 3, 5, 6 )')
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'list':
                return 'MinsalSimagdBundle:RyxLecturaPendienteTranscripcionAdmin:pndT_list_v2.html.twig';
                break;
            default:
