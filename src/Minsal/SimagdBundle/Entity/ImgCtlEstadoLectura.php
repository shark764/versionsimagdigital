 ...
 * ImgCtlEstadoLectura
 *
 * @ORM\Table(name="img_ctl_estado_lectura", uniqueConstraints={@ORM\UniqueConstraint(name="idx_codigo_estado_lectura", columns={"codigo"})})
 * @ORM\Entity
 */
class ImgCtlEstadoLectura
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="img_ctl_estado_lectura_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
