...
/**
 * ImgCtlEstadoProcedimientoRealizado
 *
 * @ORM\Table(name="img_ctl_estado_procedimiento_realizado", uniqueConstraints={@ORM\UniqueConstraint(name="idx_codigo_estado_procedimiento_realizado", columns={"codigo"})})
 * @ORM\Entity
 */
class ImgCtlEstadoProcedimientoRealizado
{
    /**
     * @var integer
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="img_ctl_estado_procedimiento_realizado_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @return ImgCtlEstadoProcedimientoRealizado
     */
