...
class MenuBuilder extends ContainerAware {
	...
	'ID' => array('label' => 'Imagenología', 'icon' => 'glyphicon glyphicon-eye-close'),
        'CT' => array('label' => 'Cita', 'icon' => 'glyphicon glyphicon-time'),
        /* MENUS PARA SISTEMA SIMAGD MODULO PREINSCRIPCIONES */
        'PI' => array('label' => 'Solicitudes', 'icon' => 'glyphicon glyphicon-book'),
        'SD' => array('label' => 'Solicitudes', 'icon' => 'glyphicon glyphicon-folder-open'),
        /* MENUS PARA SISTEMA SIMAGD MODULO CITAS */
        'CI' => array('label' => 'Citas Imagenología', 'icon' => 'glyphicon glyphicon-bookmark'),
        /* MENUS PARA SISTEMA SIMAGD MODULO DE IMAGENES */
        'IM' => array('label'=>'Imágenes Médicas', 'icon' => 'glyphicon glyphicon-picture'),
        /* MENUS PARA SISTEMA SIMAGD MODULO DE CATALOGOS*/
        'CTI' => array('label' => 'Catálogos', 'icon' => 'glyphicon glyphicon-list-alt'),
        /* MENUS PARA SISTEMA SIMAGD MODULO DE DIAGNOSTICOS */
        'DI' => array('label' => 'Diagnósticos', 'icon' =>'glyphicon glyphicon-file')
        );
    ...
    private function createStaticMenu($user) {
        ...
        {
            $this->menu['Imagenología']->addChild('Solicitudes', array('route' => 'simagd_imagenologia_digital_request_dashboard'));
        }
    }
